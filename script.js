...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const mediumLogo = document.querySelector('img[alt="medium logo"]');
  ...
  const lightLogos = {
    ...
    medium: "assets/medium-light.png",
  ...
  function setTheme(isDark) {
    ...
    mediumLogo.src = isDark ? darkLogos.medium : lightLogos.medium;
